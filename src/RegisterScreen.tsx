...
const styles = StyleSheet.create({
  ...
  input: { color: "black", borderWidth: 1, borderColor: "#ccc", borderRadius: 8, padding: 12, fontSize: 16, marginBottom: 15 },
  dropdownContainer: { color: "black", borderWidth: 1, borderColor: "#ccc", borderRadius: 8, padding: 10, marginBottom: 15 },
  registerButton: { backgroundColor: "#4A00E0", padding: 15, borderRadius: 8, alignItems: "center" },
  registerText: { color: "black", fontSize: 18, fontWeight: "bold" },
